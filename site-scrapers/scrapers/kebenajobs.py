"""
Scraper for kebenajobs.com - Jobify WordPress theme.
Jobs are in li.job_listing elements with .position, .location, .job-type classes.
"""
...
class KebenaJobsScraper(BaseScraper):
    """Scraper for Kebena Jobs site (Jobify theme)."""

    def scrape_jobs(self) -> List[Dict[str, Any]]:
        """Scrape all jobs from kebenajobs.com."""
        all_jobs = []
        page = 1
        ...
        while page <= MAX_PAGES_PER_SITE:
            if page == 1:
                ...
                # Jobify theme uses /page/N/ pattern
    ...
    def _parse_job_listing(self, listing) -> Optional[Dict[str, Any]]:
        ...
        Structure: .position > a (title + link), .location, .job-type
        In this theme, the "position" heading actually contains the company/job name.
        """
        ...
        # In the Jobify theme, the "position" heading often contains the company name
        # The actual job title might be in the link text before the company name
        # We'll need to check the detail page for the actual job title
        ...
        # Company - in this theme, company is often empty or embedded in the title
    ...
    def _scrape_detail(self, job: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        # Jobify theme: job details are in specific sections
        # Description
        desc_selectors = [
            "div.job_description",
            "div.job-description",
        ...
        # If no requirements section found, try extracting from description
